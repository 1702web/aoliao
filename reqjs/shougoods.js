...
"use strict";
define(["jquery-1.8.3.min.js"],function(){
		function ShowGoods(json){
			...
			if(typeof this.initUI!="function"){
				ShowGoods.prototype.initUI=function(){
					...
					str+="<div style='width:"+this.imgWidth+"px;height:"+this.imgHeight+"px;display:none;position:absolute;top:0;left:"+this.boxWidth+"px;overflow:hidden;z-index:999'><img src="+this.imgArr[0]+" style='position:absolute;width:"+this.imgWidth*this.times+"px;height:"+this.imgHeight*this.times+"px'/></div>";
